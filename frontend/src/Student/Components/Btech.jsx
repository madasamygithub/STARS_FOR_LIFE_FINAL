    ...
    <>
      <div className="btech-container">
        <div className="topBar">
          <button className="home-btn" onClick={() => console.log("Navigate to home")}>
            <img src={Home} alt="Home" />
            Home
          </button>
          <button className="contribution-btn" onClick={handleOpenNewContribution}>
            Contribute
          </button>
        </div>
                  ...
                  <tr key={index}>
                    ...
                    <td>
                      <button onClick={() => handleDownload(file.name)}>
                        <Icon icon="streamline:download-circle-solid" color="black" width="24" height="24" />
                      </button>
                    </td>
